...
import productimage1 from '../../images/littleheart.jpg'
import productimage2 from '../../images/lays.jpg'
import productimage3 from '../../images/kurkure.jpg'
import productimage4 from '../../images/bingo.jpg'
                          ...
                          <div className="row">
                            <div className="col-lg-6 col-12 mb-4">
                              ...
                              <div className="border p-6 rounded-3">
                                ...
                                <address>
                                  {" "}
                                  <strong>Shiva & Ruso [ Partners]</strong> <br /> Nellai Town , <br />
                                   Tirunelveli , Pin -627006 
                                  <br />
                                  <abbr title="Phone">Ph : 9150168626-9585353354</abbr>
                                </address>
                        ...
                        <li className="list-group-item px-4 py-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-5 col-md-5">
                              <h6 className="mb-0">Little Hearts</h6>
                              <span>
