...
import productimage1 from '../../images/Shawarma.jpg'
import productimage2 from '../../images/burger.png'
import productimage3 from '../../images/pizza.jpg'
import productimage4 from '../../images/sandwich.jpg'
import productimage5 from '../../images/popcorn.jpg'
                      ...
                      <li className="list-group-item py-3 py-lg-0 px-0 border-top">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-4 col-md-6">
                            {/* title */}
                            <h6 className="mb-0">Chicken Shawarma</h6>
                            <span>
