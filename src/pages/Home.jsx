...
import product1 from "../images/chips.jpg";
import product2 from "../images/banana.jpg";
// import product3 from "../images/Chips-Pouch.jpg";
import product4 from "../images/potato.jpg";
import product5 from "../images/munchie.png";
// import product6 from "../images/smith.jpg";
// import product7 from "../images/chilly.jpg";
import product8 from "../images/snak.jpg";
import product9 from "../images/walfer.jpg";
// import product10 from "../images/lays1.jpg";
                        ...
                        <div className="bg-light d-lg-flex justify-content-between align-items-center py-6 py-lg-3 px-8 rounded-3 text-center text-lg-start">
                          ...
                          <div className="mt-3 mt-lg-0">
                            ...
                            <Link to="#" className="btn btn-dark">
                              Download Tasty Picks Bazaar App
                            </Link>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className=" col-lg-6 col-md-6 fade-in-left">
                      <Slide direction="left">
                        <div className="mb-6">
                          <div className="mb-7">
                            {/* heading */}
                            <h1>Get the Tasty Picks Bazaar app</h1>
                            <h5 className="mb-0">
                          ...
                          <div className="wt-icon-box-wraper center p-a25 p-b50 m-b30 bdr-1 bdr-gray bdr-solid corner-radius step-icon-box bg-white v-icon-effect">
                            ...
                            <div className="icon-content">
                              ...
                              <p>
                                ...
                                earliest from Tasty Picks Bazaar pickup
                                <p> stores near you.</p>
                              </p>
                            </div>
                          </div>
