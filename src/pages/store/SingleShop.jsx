...
import product1 from "../../images/darkfantasy.jpg";
import product2 from "../../images/oreo.png";
import product3 from "../../images/sunfest.jpg";
import product4 from "../../images/cavins.png";
import product5 from "../../images/winkin.png";
import product6 from "../../images/Frozen.png";
import product7 from "../../images/miller.png";
import product8 from "../../images/caramel.jpg";
import product9 from "../../images/Storia.jpg";
import product10 from "../../images/shaken.jpg";
        ...
        <div className="col-lg-9 col-md-8">
          ...
          <div className="card mb-4 bg-light border-0">
            ...
            <div className=" card-body p-9">
              <h1 className="mb-0">Chocolate Shake  &amp; Milk Shake</h1>
            </div>
          </div>
          {/* list icon */}
                ...
                <div className="card-body">
                  ...
                  <div className="text-small mb-1">
                    <Link to="#!" className="text-decoration-none text-muted">
                      <small>Chocolate &amp; MilkShake</small>
                    </Link>
                  </div>
                  <h2 className="fs-6">
            ...
            <div className="col">
              ...
              <div className="card card-product">
                <div className="card-body">
                  ...
                  <div className="text-small mb-1">
                    <Link to="#!" className="text-decoration-none text-muted">
                      <small>Chocolate&amp; Butter Milk</small>
                    </Link>
                  </div>
                  <h2 className="fs-6">
                    <Link to="#!" className="text-inherit text-decoration-none">
            ...
            <div className="col">
              ...
              <div className="card card-product">
                <div className="card-body">
                  ...
                  <div className="text-small mb-1">
                    <Link to="#!" className="text-decoration-none text-muted">
                      <small>Caramel Flavour</small>
                    </Link>
                  </div>
                  <h2 className="fs-6">
                    <Link to="#!" className="text-inherit text-decoration-none">
                      Cadbury Creamy shake 
                    </Link>
                  </h2>
                  <div className="text-warning">
                    {/* rating */}
            ...
            <div className="col">
              ...
              <div className="card card-product">
                <div className="card-body">
                  ...
                  <div className="text-small mb-1">
                    <Link to="#!" className="text-decoration-none text-muted">
                      <small>No Added Sugar  &amp; Cream</small>
                    </Link>
                  </div>
                  <h2 className="fs-6">
                    <Link to="#!" className="text-inherit text-decoration-none">
                    Storia Chocolate Milkshake{" "}
                    </Link>
                  </h2>
                  <div className="text-warning">
                    {/* rating */}
            ...
            <div className="col">
              ...
              <div className="card card-product">
                <div className="card-body">
                  ...
                  <div className="text-small mb-1">
                    <Link to="#!" className="text-decoration-none text-muted">
                      <small>Chocolush &amp; Milkshake</small>
                    </Link>
                  </div>
                  <h2 className="fs-6">
                    <Link to="#!" className="text-inherit text-decoration-none">
