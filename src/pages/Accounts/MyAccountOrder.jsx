...
import productimg1 from "../../images/KFC.png";
import productimg2 from "../../images/oreo.png";
import productimg3 from "../../images/bingo.jpg";
import productimg4 from "../../images/darkfantasy.jpg";
import productimg5 from "../../images/winkin.png";
import productimg6 from "../../images/pizza.jpg";
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td className="align-middle border-top-0">
                                  ...
                                  <span>
                                    <small className="text-muted">800gm</small>
                                  </span>
                                </td>
                                <td className="align-middle border-top-0">
                              ...
                              <tr>
                                ...
                                <td className="align-middle border-top-0">
                                  ...
                                  <span>
                                    <small className="text-muted">200ml</small>
                                  </span>
                                </td>
                                <td className="align-middle border-top-0">
                                  <Link to="#" className="text-inherit">
                              ...
                              <tr>
                                ...
                                <td className="align-middle border-top-0">
                                  ...
                                  >
                                    <h6 className="mb-0">
                                      Dark Fantcy Chocolate Shake{" "}
                                    </h6>
                                  </Link>
                                  <span>
                                    <small className="text-muted">600 ml</small>
                                  </span>
                                </td>
                                <td className="align-middle border-top-0">
                                  <Link to="#" className="text-inherit">
                              ...
                              <tr>
                                ...
                                <td className="align-middle border-top-0">
                                  ...
                                  <span>
                                    <small className="text-muted">300ml</small>
                                  </span>
                                </td>
                                <td className="align-middle border-top-0">
                                  <Link to="#" className="text-inherit">
