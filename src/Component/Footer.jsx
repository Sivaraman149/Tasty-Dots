...
import groceryshop from "../images/tastt.png";
                  ...
                  <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                    ...
                    <ul className="list-inline d-flex mb-0">
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={amazonpay} alt="footerTasty Picks Bazaar" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={american} alt="footerTasty Picks Bazaar" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={mastercard} alt="footerTasty Picks Bazaar" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={paypal} alt="footerTasty Picks Bazaar" />
                        </Link>
                      </li>
                      <li className="list-inline-item">
                        <Link to="#!">
                          <img src={visa} alt="footerTasty Picks Bazaar" />
                        </Link>
                      </li>
                    </ul>
                  </div>
